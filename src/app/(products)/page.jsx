    ...
    <div className="overflow-y-auto w-full h-full flex gap-4 flex-wrap items-center justify-center md:justify-start">
      {
        data.slice(0, 4).map((product) => (
          <div className="bg-secondary-200 w-[268px] h-96 rounded-xl overflow-hidden" key={product.id}>
            {/* image product */}
            <div className="w-full h-1/2 overflow-hidden flex items-center justify-center">
              <img src="https://assets.adidas.com/images/w_940,f_auto,q_auto/5ae668a4e81749d6aa8c88dfee7c9882_9366/ID4989_01_standard.jpg" className="rounded-t-xl" alt="test" />
            </div>
            <div className="w-full h-1/2 pt-10 relative flex flex-col items-end p-4 justify-between">
              <div className="w-full left-0 px-3 absolute flex items-center justify-between -top-[24px]">
                ...
                {/* category Image */}
                <div className="w-12 h-12 overflow-hidden bg-red-500 rounded-xl flex items-center justify-center relative">
                    <img src="https://cdn.thewirecutter.com/wp-content/media/2023/09/running-shoes-2048px-5960.jpg" className="" alt="" />
              ...
              <p className="text-secondary-0">{product.title}</p>
